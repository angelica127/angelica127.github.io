---
title: "Spring Framework Project 설정 정리"
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
	...
	<!-- maven에 등록된 라이브러리 찾아보기 : search.maven.org -->
	<dependencies>
		<!-- Spring -->
		<dependency>
		...
		<!-- Servlet -->
		<!-- Servlet은 web.xml에 tag랑 연결되어 있다. pom.xml을 수정하면 web.xml의 <web-app>의
			속성을 version에 맞게 바꿔줘야 한다. 2.5 -> 3.1.0 으로 수정 -->
		<dependency>
